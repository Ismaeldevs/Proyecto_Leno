...
export const URL_STOCK_CREAR = 'http://localhost:8000/stocks/create/'
export const URL_STOCK_EDITAR = 'http://localhost:8000/stocks/edit/'
export const URL_STOCK_ELIMINAR = 'http://localhost:8000/stocks/delete/'

export const URL_EMPLEADO = 'http://localhost:8000/empleados'
export const URL_EMPLEADO_CREAR = 'http://localhost:8000/empleados/create/'
...
export const URL_SUCURSAL_ELIMINAR = 'http://localhost:8000/sucursales/delete/'

export const URL_PEDIDO = 'http://localhost:8000/pedidos'
